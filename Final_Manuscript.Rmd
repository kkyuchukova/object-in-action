...
ENTIRE PARAGRAPH ON MODERN (POST-2016) STUDIES OF INTERPERSONAL OBJECTIFICATION. 

Empirical evidence reveals that objectification manifests through inauthenticity in romantic relationships [@brunelletal2010], adverse attitudes in regard to career aspirations, and a decrease in concentration and impairment in female cognitive performance [@quinnetal]. 
...
clark_careerasp_alpha <- psych::alpha(select(clark_measures, careerasp_1, careerasp_2, 
...
smith_careerasp_alpha <- psych::alpha(select(smith, careerasp_1, careerasp_2, 
                                             careerasp_3, careerasp4.r, careerasp_5, 
                                             careerasp_6, careerasp7.r, careerasp_8, 
                                             careerasp_9, careerasp10.r))$total[2]
```
...
Before moving to the main analyses, we discuss statistical equivalence test that provide support for combining Sample 1 and Sample 2 in one analysis sample. The online supplemental material contains the main analyses separated by samples. 
...
```{r}
#SSO
apim1 <- gls(howbody_avg_A ~ a2pSOO_A + a2pSOO_P + TSO_A + a2pSOO_P*TSO_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)

apim1.b <- gls(howbody_avg_A ~ a2pSOO_A + a2pSOO_P + TSO_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
```{r}
#authenticity
apim2 <- gls(authenticity_A ~ howbody_avg_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
#Trying to perform analyses for each item for a footnote...will need to get to the bottom of this. 
# inter_1, inter_3, inter_5, inter_6, 
# inter_7, inter_9, inter_10, interaux_5, 
# interaux_6
# 
# apim2 <- gls(inter_1 ~ howbody_avg_A, 
#                  na.action=na.omit, 
#                  correlation=corCompSymm (form=~1|dyadID),
#                  data=clarksmith_women)

apim2.b <- gls(authenticity_A ~ howbody_avg_A + a2pSOO_P, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim2.c <- gls(authenticity_A ~a2pSOO_P, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
```{r}
#cognitive performance
apim3 <- gls(trigram_score_A ~ authenticity_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim3.b <- gls(trigram_score_A ~ authenticity_A + howbody_avg_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim3.c <- gls(trigram_score_A ~ authenticity_A + howbody_avg_A + a2pSOO_P, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
```{r}
#relationship agency
apim4 <- gls(relag_A ~ authenticity_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim4.b <- gls(relag_A ~ authenticity_A + howbody_avg_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim4.c <- gls(relag_A ~ authenticity_A + howbody_avg_A + a2pSOO_P, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
```{r}
#career aspirations
apim5 <- gls(careerasp_A ~ authenticity_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim5.b <- gls(careerasp_A ~ authenticity_A + howbody_avg_A, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
apim5.c <- gls(careerasp_A ~ authenticity_A + howbody_avg_A + a2pSOO_P, 
                 na.action=na.omit, 
                 correlation=corCompSymm (form=~1|dyadID),
                 data=clarksmith_women)
...
Contrary to expectations, there was no significant effect of SSO on interaction authenticity, although the estimate of this effect was in the hypothesized negative direction, `r report_stats(apim2, 2)`. Because authenticity was a composite score of 9 items, two of which were interaction specific authenticity items, we also tested the effect of SSO on these items individually...ADD ANALYSIS...Although we hypothesized that SSO would mediate the relationship between partner's other objectification and interaction authenticity, after finding no relationship bewteen SSO and authencity, we also tested if the partner's other objectification had a direct effect on authenticity, but this effect was not significant, `r report_stats(apim2.b, 3)` (nor was the total effect of partner's other objectification on authenticity, `r report_stats(apim2.c, 2)`). 
