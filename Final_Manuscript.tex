...
OUTLINE - Introduction: Objectification theory says stuff. Recently
we've learned about interpersonal objectification but we only know it
about mixed gender. We know women objectify each other, but what about
in interpersonal interactions? - Self-objectification - SSO versus TSO -
Does this process of self-objectification also lead women to objectify
other women? - Women objectifying other women - Lots of evidence, but we
don't know if this happens interpersonally - Interpersonal
objectifcation research is a whole thing now, but there are no studies
(or theoretical models) that include women-on-women interpersonal
objectification processes. - Relationships and objectification - Both
romantic relationships and relationships in general have been studies in
the context of objectification, but neither of these literatures have
investigated specifically same-gender relationships. - Authenticity
paragraph? - Current Study - Alternative predictions

Roberts and Fredrickson (1997)\enquote{s Objectification Theory,
suggests that women are objectified in interpersonal encounters, and
that the effect might be strongest from men, but possibly also from
women. Psychological researchers studying the sexual objectification of
women, and the resulting self-objectification that follows, have in
recent years explored the interpersonal process of the objectification -
self-objectification link. For exmaple, in a face-to-face mixed-gender
dyadic study, Garcia, Earnshaw, and Quinn (2016) found that men's
reported objectificaiton of their female interaction partner during an
interaction was associated with increased sefl-objectification reported
...
is only relevant for mixed-gender encouters. Although there is ample
...
Does this habit self-objectification lead women to also objectify other
women, possibly to compare oneself?
...
(Briton \& Hall, 1995, CITE saguy skype study, calogero video walking
study), often times feel \enquote{looked at} within interpersonal
interactions (Argyle \& Williams, 1969), and will more than likely
internalize the objectifying gaze on physical self (Young, 1979).
Moreover, perhaps the most adverse effect of objectifying treatment is
that it effectively socializes girls and women to treat themselves as
objects to be looked at and evaluated, an effect termed
self-objectification (Bartky, 1990; Berger, Cohen, \& Zelditch Jr, 1972;
L. Fredrickson, Roberts, M. Noll, Quinn, \& Twenge, 1998). We don't know
about women-on-women interpersonal objectification. What might be
different?
...
women need to look attractive to obtain and maintain successfuol
relationship, thus, the ``college relationships condition may highten
...
self-objectification on the reduction of relationship biulding skills in
...
(D. M. Quinn, Chaudoir, \& Kallen, 2011).

MAYBE SEPARATE PARAGRAPH ABOUT AUTHENTICITY LINK SPECIFICALLY. And how
woman-woman interpersonal objectificaiton preocesses might diverge from
this process. {[}again CITE PWQ paper I reviewed, Yoder editor{]}.
...
interpersonal discrimination and expereince daily sexist hassles (Swim,
...
operalization of self-objectification may be improved.
