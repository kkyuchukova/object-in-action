...
setwd("/Users/katerinakyuchukova/Downloads/kat/")
```

Load data
```{r}
#clark
clark_measures <- read_spss("Clark College Relationships Data/College_Relationship_Measures_1.sav")
clark_pairwise <- read_spss("Clark College Relationships Data/College_Relationship_Pairwise_1.sav")

#smith
smith <- read_spss("College_Relationship_Dyadic_September_14_2018_12_17.sav")

clark_sentences <- read.csv("sexist sentences/coded_sentences.csv")

#trigrams
trigram_check <- read.csv("Clark College Relationships Data/trigrams/AMELIA_check_trigram_grading.csv")
```
...
smith <- smith %>%
  mutate(physanx5.r = (min(physanx_5, na.rm = TRUE) + max(physanx_5, na.rm = TRUE) - physanx_5),
         physanx = (physanx_1 +physanx_2 +physanx_3+physanx_4+physanx5.r+physanx_6)/6) #reverse code physical anxiety variable
...
smith_trigrams_graded <- read.csv("Smith College Relationships Data/trigrams_graded.csv")
...
kat_codes <- read.csv("/Users/katerinakyuchukova/Downloads/kat/Smith College Relationships Data/kat_recode.csv")

xinyu_codes <- read.csv("/Users/katerinakyuchukova/Downloads/kat/Smith College Relationships Data/xinyu_recode.csv")
...
```{r}
write.csv(smith_final, "/Users/katerinakyuchukova/Desktop/ObjectInAction/Cleaned data/smith_final.csv" )
write.csv(clark_final, "/Users/katerinakyuchukova/Desktop/ObjectInAction/Cleaned data/clark_final.csv")
```
